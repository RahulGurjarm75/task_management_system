...
<nav class="navbar">
  ...
  <form action="phpSearch.php" method="post">
   ...
   <button class="btn  m-3" onclick="myFunction()">Filter</button>
    ...
    <!-- filter -->
    <div class="container-fluid" id="myDIV" style="display:block;padding-left: 490px;" >
  ...
  <label style="padding-top: 5px;">Date:</label>
    ...
    <table class="table table-hover text-center">
      ...
      <tbody>
        ...
        $sql = "select * from task where taskStatus = '$taskStatus' or date(`Sdate`) BETWEEN '$date1' AND '$date2'";
        // $x for sr no
        $x=0;
